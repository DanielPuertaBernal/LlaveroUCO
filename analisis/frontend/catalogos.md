...
- **`SalonesPage`** (`src/features/salones/SalonesPage.jsxxx:50`): vista maestro-detalle con drill-down. Nivel 1: grid de bloques con conteo de salones (`bloquesSalones`, línea 93-106). Nivel 2 (al seleccionar un bloque): grid de salones de ese bloque (`salonesDelBloque`, línea 108-121), con búsqueda por nombre/tipo/capacidad. Gestiona además, en el mismo componente, dos catálogos adicionales vía `Sheet` lateral: CRUD de bloques y CRUD de tipos de silletería (edición inline en lista, líneas 574-653).
