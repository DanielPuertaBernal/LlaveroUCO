...
const options = {
  definition: {
    ...
    components: {
      securitySchemes: {
        BearerAuth: {
          ...
          scheme: 'bearer',
          bearerFormat: 'JWT',
          description: 'Token JWT obtenido en /auth/office365/login (Office365) o /auth/refresh',
        },
      },
      schemas,
    },
    tags: [
      ...
      { name: 'NFC', description: 'Búsqueda de personas por carnet/documento (lector NFC como teclado)' },
